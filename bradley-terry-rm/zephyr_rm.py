...
# This script is designed for the reward modeling with Zephyr model which should be handled carefully because it does not have an official pad token
...
class ScriptArguments:
    ...
    output_path: Optional[str] = field(
        default="./bt_models/zephyr_rm_test",
